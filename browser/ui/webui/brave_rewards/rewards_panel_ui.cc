...
- Better (decent) debugging for panel "spinner" stalls.
- Add context-click to Rewards button to hide the button?
- When rewards icon is hidden and we open the panel, the anchoring is a bit off.
  ...
  because "ShowUI" is called before the button is made visible.
- Test adaptive captcha. I suspect that it will not work without adding
