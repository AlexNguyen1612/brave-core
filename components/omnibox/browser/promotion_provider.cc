...
void PromotionProvider::AddMatchForBraveSearchPromotion(
  ...
  // TODO(simonhong): Revisit this match type. As this has lower priority than
  // history entries, this search promotion entry could not be visible when
  // other providers supply many related matches from history.
  AutocompleteMatch match(this, kRelavance, true,
