...
TEST(BatAdsExclusionRuleFeaturesTest, IsEnabled) {
  ...
  // Act
  const bool is_enabled = features::exclusion_rules::IsEnabled();
...
TEST(BatAdsExclusionRuleFeaturesTest, IsDisabled) {
  ...
  disabled_features.push_back(features::exclusion_rules::kFeature);
...
TEST(BatAdsExclusionRuleFeaturesTest, ShouldExcludeAdIfConverted) {
  ...
  enabled_features.push_back(
      {features::exclusion_rules::kFeature, kParameters});
  ...
  const bool should_exclude_ad_if_converted =
      features::exclusion_rules::ShouldExcludeAdIfConverted();
...
TEST(BatAdsExclusionRuleFeaturesTest, ExcludeAdIfDismissedWithinTimeWindow) {
  ...
  std::vector<base::test::ScopedFeatureList::FeatureAndParams> enabled_features;
  enabled_features.push_back({features::exclusion_rules::kFeature, parameters});
  ...
  const base::TimeDelta time_window =
      features::exclusion_rules::ExcludeAdIfDismissedWithinTimeWindow();
...
TEST(BatAdsUserActivityFeaturesTest, ExcludeAdIfTransferredWithinTimeWindow) {
  ...
  // Act
  const base::TimeDelta time_window =
      features::exclusion_rules::ExcludeAdIfTransferredWithinTimeWindow();
